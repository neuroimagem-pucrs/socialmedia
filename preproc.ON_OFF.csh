...
afni_proc.py \
	...
	-dsets ${runA}1/${study}${subj}.${runA}1.nii.gz	\
	       ${runA}2/${study}${subj}.${runA}2.nii.gz	\
	       ${runA}3/${study}${subj}.${runA}3.nii.gz	\
	       ${runB}1/${study}${subj}.${runB}1.nii.gz	\
	       ${runB}2/${study}${subj}.${runB}2.nii.gz	\
	       ${runB}3/${study}${subj}.${runB}3.nii.gz	\
